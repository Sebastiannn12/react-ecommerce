...
const ProductList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // This fetches the data you just added to product.js via your API
        const response = await fetch("https://react-ecommerce-backend-x3rr.onrender.com/api/products");
          ...
          <div className="col-lg-3 col-md-4 mb-4 px-3">
            ...
            >
              <div className="card-body p-0">
                ...
                <div
                  className="p-3"
                  style={{ backgroundColor: darkBg, color: "#ffffff" }}
                >
                  <h6 className="fw-bold text-uppercase small mb-3">
                    Refine Results
                  </h6>
